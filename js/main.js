document.querySelector(".menu-link").addEventListener('click', (e)=>{
  ...
  document.querySelector(".mobile-menu-1").addEventListener('click', (e)=>{
    document.querySelector('.mobile-menu-container').setAttribute("style", "visibility:hidden");
  })
  
  document.querySelector(".mobile-menu-2").addEventListener('click', (e)=>{
    document.querySelector('.mobile-menu-container').setAttribute("style", "visibility:hidden");
  })
  
  document.querySelector(".mobile-menu-3").addEventListener('click', (e)=>{
    document.querySelector('.mobile-menu-container').setAttribute("style", "visibility:hidden");
  })
